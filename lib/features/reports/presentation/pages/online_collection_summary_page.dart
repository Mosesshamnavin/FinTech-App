    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ReportBloc, ReportState>(
        ...
        builder: (ctx, state) => BlocBuilder<SettingsBloc, SettingsState>(builder: (context, ss) {
          ...
          return Scaffold(
            appBar: AppBar(title: Text('Online Collection Summary'.tr()), leading: IconButton(icon: const Icon(Icons.arrow_back_ios_new, size: 20), onPressed: () => Navigator.pop(context))),
