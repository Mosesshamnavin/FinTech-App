...
class OnlineCollectionSummaryPage extends StatefulWidget {
  const OnlineCollectionSummaryPage({super.key});
  @override State<OnlineCollectionSummaryPage> createState() => _OnlineCollectionSummaryPageState();
}
class _OnlineCollectionSummaryPageState extends State<OnlineCollectionSummaryPage> {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ReportBloc, ReportState>(
        ...
        builder: (ctx, state) => BlocBuilder<SettingsBloc, SettingsState>(builder: (context, ss) {
          ...
          return Scaffold(
            appBar: AppBar(title: const Text('Online Collection Summary'), leading: IconButton(icon: const Icon(Icons.arrow_back_ios_new, size: 20), onPressed: () => Navigator.pop(context))),
