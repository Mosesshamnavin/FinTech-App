...
class NewBadLoanByDateSummaryPage extends StatefulWidget {
  const NewBadLoanByDateSummaryPage({super.key});

  @override
  State<NewBadLoanByDateSummaryPage> createState() => _NewBadLoanByDateSummaryPageState();
}

class _NewBadLoanByDateSummaryPageState extends State<NewBadLoanByDateSummaryPage> {
  String? _lineType;
  String? _line;
  bool _lineAll = true;
