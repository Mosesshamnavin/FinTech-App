...
class InvestmentExpenseSummaryPage extends StatefulWidget {
  const InvestmentExpenseSummaryPage({super.key});

  @override
  State<InvestmentExpenseSummaryPage> createState() => _InvestmentExpenseSummaryPageState();
}

class _InvestmentExpenseSummaryPageState extends State<InvestmentExpenseSummaryPage> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SettingsBloc, SettingsState>(
      builder: (context, settingsState) {
        ...
        return Scaffold(
      appBar: AppBar(
        title: const Text('Investment/Expense Summary'),
        leading: IconButton(
